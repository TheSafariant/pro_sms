        ...
        <div class="white-box">
            <div class="row">
                <div class="col-lg-3 col-md-3  col-sm-12 col-xs-12 inbox-panel">
                    <div> 
                <a href="<?php echo base_url(); ?>index.php?parents/message/message_new" class="btn btn-custom btn-block waves-effect waves-light"><?php echo get_phrase('New');?></a>
<hr>
            ...
            <h3 class="panel-title m-t-40 m-b-0">Labels</h3>
                <hr class="m-t-5">
                        ...
                        <a href="#" class="list-group-item"><span class="fa fa-circle text-warning m-r-10"></span><?php echo get_phrase('Teachers');?></a> 
                         </div>
                    </div>
                </div>
