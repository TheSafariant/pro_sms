...
<div class="main_data">
	...
	<tbody>
        ...
        <td style="text-align: center;">
		    <a href="<?php echo base_url();?>index.php?parents/newsroom/overview/<?php echo $row['news_code'];?>">
			<?php echo $row['title'];?>         
            </a>
        </td>
		<td style="text-align: center;">
          <a class="btn btn-info tooltip-primary" data-toggle="tooltip" data-placement="top"
            	  href="<?php echo base_url();?>index.php?parents/newsroom/overview/<?php echo $row['news_code'];?>">
