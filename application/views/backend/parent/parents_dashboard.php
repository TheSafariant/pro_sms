<div class="row bg-title">
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>index.php?parents/teacher_dashboard"><?php echo $system_title; ?></a></li>
            <li class="active"><?php echo get_phrase('Parents-Dashboard');?></li>
        </ol>
    </div>
</div>
...
<div class="row">
            ...
            <a href="<?php echo base_url();?>index.php?parents/newsroom/overview/<?php echo $row['news_code'];?>"><?php echo $row['title'];?></a>
    </td>
