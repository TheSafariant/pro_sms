...
<div class="row">
	<div class="col-md-2">
		<a style="text-align: left;" href="<?php echo base_url();?>index.php?teacher/forumroom/posts/<?php echo $post_code;?>" 
        ...
        <a style="text-align: left;" href="<?php echo base_url();?>index.php?teacher/forumroom/edit/<?php echo $post_code;?>" 
			class="<?php if ($room_page == 'post_edit')  echo 'btn btn-warning';
			else echo 'btn btn-info';?> btn-block btn-icon icon-left">
