					...
					<tr>
						...
						<td>
							<input type="text" class="form-control" name="marks_obtained_<?php echo $row['mark_id'];?>"
								style="width:60px;height:30px" value="<?php echo $row['mark_obtained'];?>" <?php if($row['mark_obtained'] != 0 && $allowed == 2) echo 'readonly';?>>	
						</td>
						<td>
							<input type="text" class="form-control" name="lab_uno_<?php echo $row['mark_id'];?>"
								style="width:60px;height:30px" value="<?php echo $row['labuno'];?>" <?php if($row['labuno'] != 0 && $allowed == 2) echo 'readonly';?>>	
						</td>
						<td>
							<input type="text" class="form-control" name="lab_dos_<?php echo $row['mark_id'];?>"
								style="width:60px;height:30px" value="<?php echo $row['labdos'];?>" <?php if($row['labdos'] != 0 && $allowed == 2) echo 'readonly';?>>	
						</td>
						<td>
							<input type="text" class="form-control" name="lab_tres_<?php echo $row['mark_id'];?>"
								style="width:60px;height:30px" value="<?php echo $row['labtres'];?>" <?php if($row['labtres'] != 0 && $allowed == 2) echo 'readonly';?>>	
						</td>
						<td>
							<input type="text" class="form-control"  name="lab_cuatro_<?php echo $row['mark_id'];?>"
								style="width:60px;height:30px" value="<?php echo $row['labcuatro'];?>" <?php if($row['labcuatro'] != 0 && $allowed == 2) echo 'readonly';?>>	
						</td>
						<td>
							<input type="text" class="form-control"  name="lab_cinco_<?php echo $row['mark_id'];?>"
								 style="width:60px;height:30px" value="<?php echo $row['labcinco'];?>" <?php if($row['labcinco'] != 0 && $allowed == 2) echo 'readonly';?>>	
						</td>
						<td>
							<input type="text" class="form-control" name="lab_seis_<?php echo $row['mark_id'];?>"
								style="width:60px;height:30px" value="<?php echo $row['labseis'];?>" <?php if($row['labseis'] != 0 && $allowed == 2) echo 'readonly';?>>	
						</td>
						<td>
							<input type="text" class="form-control" name="lab_siete_<?php echo $row['mark_id'];?>"
								style="width:60px;height:30px" value="<?php echo $row['labsiete'];?>" <?php if($row['labsiete'] != 0 && $allowed == 2) echo 'readonly';?>>	
						</td>
						<td>
							<input type="text" class="form-control" name="lab_ocho_<?php echo $row['mark_id'];?>"
								style="width:60px;height:30px" value="<?php echo $row['labocho'];?>" <?php if($row['labocho'] != 0 && $allowed == 2) echo 'readonly';?>>	
						</td>
						<td>
							<input type="text" class="form-control" name="lab_nueve_<?php echo $row['mark_id'];?>"
								 style="width:60px;height:30px" value="<?php echo $row['labnueve'];?>" <?php if($row['labnueve'] != 0 && $allowed == 2) echo 'readonly';?>>
						</td>
						<td>
							<input type="text" class="form-control" name="comment_<?php echo $row['mark_id'];?>"
								value="<?php echo $row['comment'];?>" <?php if($row['comment'] != '' && $allowed == 2) echo 'readonly';?>>
						</td>
					</tr>
				<?php endforeach;?>
				</tbody>
