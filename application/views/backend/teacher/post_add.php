        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title" >
                  <center> <font color="white"><?php echo get_phrase('CreatePost'); ?></font></center>
                </div>
            </div>
            <br><br>
            <div class="panel-body">
                <?php echo form_open(base_url() . 'index.php?teacher/forum/create/', array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea class="form-control textarea_editor" rows="10" required name="description" id="post_content"></textarea>
                    </div>
                </div>
