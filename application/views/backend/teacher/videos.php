<div class="row bg-title">
                ...
                <div class="row el-element-overlay">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title"><?php echo get_phrase('Gallery');?></h3>
                            <div class="row">
                            <?php
                                    ...
                                    <div class="el-card-item">
                                        <div class="el-card-avatar el-overlay-1"> <img src="uploads/screen/<?php echo $row['category_id']; ?>.jpg" />
                                            <div class="el-overlay">
                                                <ul class="el-info">
                                                    <li><a class="btn default btn-outline" href="<?php echo base_url(); ?>index.php?teacher/video_detail/<?php echo $row['category_id']; ?>"><i class="fa fa-play-circle-o fa-3x"></i></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="alb-info">
