        ...
        <div class="panel panel-info" data-collapsed="0">
            <div class="panel-heading">
                <div class="panel-title" >
                    <font color="white"><?php echo get_phrase('Upload-Book'); ?></font>
                </div>
            </div>
            <div class="panel-body">
                <?php
                echo form_open(base_url() . 'index.php?admin/upload_book', array(
                ...
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-5">
                        <button type="submit" class="btn btn-info">
                            <i class="entypo-upload"></i> <?php echo get_phrase('Upload-Book'); ?>
                        </button>
                    </div>
                </div>
                <?php echo form_close(); ?>
