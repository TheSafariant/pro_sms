    ...
    <tbody>
        ...
        foreach ($requests as $row) { ?>   
            <tr>
                ...
                <td style="text-align: center;"><?php echo $this->db->get_where('student', array('student_id' => $row['student_id']))->row()->name; ?></td>
                    ...
                    <?php if($row['status'] == 0) { ?>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-blue pull-right" role="menu">
                                <li>
                                    <a href="<?php echo base_url();?>index.php?admin/request_student/accept/<?php echo $row['request_id'];?>">
                                        <i class="entypo-check"></i>
                                        <?php echo get_phrase('Accept');?>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>index.php?admin/request_student/reject/<?php echo $row['request_id'];?>">
