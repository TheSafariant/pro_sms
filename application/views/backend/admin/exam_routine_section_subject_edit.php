<?php
	...
	if($query->num_rows() > 0): 
		$section_id = $this->db->get_where('horarios_examenes' , array('horario_id' => $horario_id))->row()->section_id;
...
<?php endif;?>
<?php
	$subject_id = $this->db->get_where('horarioss_examenes' , array('horario_id' => $horario_id))->row()->subject_id;
?>
<div class="form-group">
