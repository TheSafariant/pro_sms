...
<hr/>
<a href="<?php echo base_url();?>index.php?admin/add_exam_routine"
                        ...
                        <tr class="gradeA">
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                 ...
                                 <li>
                                    <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/exam_routine/delete/<?php echo $row2['horario_id'];?>');">
