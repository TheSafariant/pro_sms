...
<div class="tab-content">
            ...
            <table id="myTable" class="table table-striped">
              ...
              <?php foreach($exams as $row):?>
                ...
                <td style="text-align: center;"><?php echo $row['comment'];?></td>
			         <td style="text-align: center;" class="text-nowrap"><a href="#" data-toggle="tooltip" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/units_edit/<?php echo $row['exam_id'];?>');" data-original-title="Edit"> <i class="fa fa-edit text-info"></i> </a></td>
               <td style="text-align: center;" class="text-nowrap"><a href="#" data-toggle="tooltip" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/semesters/delete/<?php echo $row['exam_id'];?>');" data-original-title="Delete"> <i class="fa fa-trash text-danger"></i> </a></td>
                </tr>
                <?php endforeach;?>
              </tbody>
            </table>
	...
	<div class="tab-pane box" id="add" style="padding: 5px">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/semesters/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
          ...
          <div class="white-box">
            ...
            <br><br>
				<div class="padded">
                    ...
                    <div class="col-sm-5">
                      <input type="text" class="form-control" required="" name="comment" placeholder="<?php echo get_phrase('Description');?>">
                  </div>
                            </div>
				  <hr>
