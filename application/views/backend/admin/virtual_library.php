...
<a href="javascript:;" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/add_book/');" 
		...
		<div class="tabs-vertical-env">
			...
			?>
				<li class="<?php if ($row['class_id'] == $class_id) echo 'active';?>">
					<a href="<?php echo base_url();?>index.php?admin/virtual_library/<?php echo $row['class_id'];?>">
							...
							<tr>
								...
								<td style="text-align: center;">
									<a class="btn btn-info"
										href="<?php echo base_url();?>index.php?admin/download_book/<?php echo $row['libro_code'];?>">
										<i class="fa fa-download"></i> <?php echo get_phrase('Download');?>
									</a>
								</td>
								<td style="text-align: center;">
									<a class="btn btn-danger"
										href="<?php echo base_url();?>index.php?admin/delete_book/<?php echo $row['libro_id'];?>">
