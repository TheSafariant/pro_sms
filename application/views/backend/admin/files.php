...
<div class="tab-content">
        ...
        foreach ($poa_info as $row) { ?>   
                ...
                <td style="text-align: center;" class="text-nowrap"><a href="<?php echo base_url();?>index.php?admin/files/delete/<?php echo $row['id_poa']?>" onclick="return confirm('<?php echo get_phrase('Are-you-sure');?>');" data-toggle="tooltip" data-original-title="Delete"> <i class="fa fa-trash text-danger"></i> </a></td>
                </tr>
                <?php } ?>
              </tbody>
            </table>
	...
	<div class="tab-pane box" id="add" style="padding: 5px">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/files/create', array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
          ...
          <div class="white-box">
            ...
            <br><br>
				<div class="padded">
                    ...
                    <div class="col-sm-5">
                      <input type="text" class="form-control mydatepicker" required="" name="timestamp" placeholder="<?php echo get_phrase('Date');?>">
                    </div>
                  </div>
                    ...
                    <div class="col-sm-5">
                      <input type="text" class="form-control" required="" name="title" placeholder="<?php echo get_phrase('Name');?>">
                    </div>
                  </div>
                    ...
                    <div class="col-sm-5">
                      <textarea type="text" class="form-control" required="" name="description" placeholder="<?php echo get_phrase('Description');?>"></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input type="file" name="file_name" class="form-control file2 inline btn btn-info" data-label="<i class='glyphicon glyphicon-file'></i><?php echo get_phrase('Search');?>" />
