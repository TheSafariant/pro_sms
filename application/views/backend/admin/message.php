        ...
        <div class="white-box">
            <div class="row">
                <div class="col-lg-3 col-md-3  col-sm-12 col-xs-12 inbox-panel">
                    <div> 
                <a href="<?php echo base_url(); ?>index.php?admin/message/message_new" class="btn btn-custom btn-block waves-effect waves-light"><?php echo get_phrase('New');?></a>
            <hr>
            ...
            foreach ($message_threads as $row):
                ...
                ?>
            <a href="<?php echo base_url(); ?>index.php?admin/message/message_read/<?php echo $row['message_thread_code']; ?>">
            <hr>
            ...
            <?php endif; ?><?php echo $this->db->get_where($user_to_show_type, array($user_to_show_type . '_id' => $user_to_show_id))->row()->name; ?></a> 
            ...
            <h3 class="panel-title m-t-40 m-b-0">Labels</h3>
                <hr class="m-t-5">
                        ...
                        <?php echo get_phrase('Teachers');?></a> 
                        <a href="#" class="list-group-item"><span class="fa fa-circle text-warning m-r-10"></span><?php echo get_phrase('Students');?></a> 
                        <a href="#" class="list-group-item"><span class="fa fa-circle text-success m-r-10"></span><?php echo get_phrase('Parents');?></a> </div>
                    </div>
                </div>
