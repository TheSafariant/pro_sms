...
'post_code' => $post_code))->result_array(); foreach ($current as $row): ?>
    ...
    <div class="panel panel-primary" data-collapsed="0">
            <div class="panel-heading">
                <div class="panel-title"><font color="white"><?php echo get_phrase('Discussion'); ?></font></div>
</div>          
<div class="panel-body">                
        <?php echo form_open(base_url() . 'index.php?student/forum_message/add/' . $post_code, array(
...
<script>
    var post_refresh_url    =   '<?php echo base_url();?>index.php?student/reload_post_comment/<?php echo $post_code;?>';
